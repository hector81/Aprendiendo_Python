...
def introducirMiApuestaSencilla():
    # introducir tus numeros de euromillon
    print('Introduce tus numeros de euromillon. Son 5 y no deben ser negativos, ni 0 ni mayor de 50')
    contadorNumerosPrimitiva = 1
    miPrimitiva = []
    miNumero = 0
    # ponemos numeros primitiva
    while contadorNumerosPrimitiva < 6:
        # ponemos el numero
    ...
    print('Introduce tus series o estrellas de euromillon. Son 2 y no deben ser negativos, ni 0 ni mayor de 12')
    contadorSeriesPrimitiva = 1
    misSeries = []
    miSerie = 0
    # ponemos numeros primitiva
    while contadorSeriesPrimitiva < 3:
        # ponemos el numero
...
# operaciones
miApuesta = introducirMiApuestaSencilla()
